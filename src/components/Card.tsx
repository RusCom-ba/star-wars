  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 p-3 space-y-0.5">
        ...
        <p>Height: <strong>{character.height} cm</strong></p>
        <p>Mass: <strong>{character.mass} kg</strong></p>
        <p>Hair color: <strong>{capitalizeFirst(character.hair_color)}</strong></p>
        <p>Skin color: <strong>{capitalizeFirst(character.skin_color)}</strong></p>
        <p>Eye color: <strong>{capitalizeFirst(character.eye_color)}</strong></p>
        <p>Birth year: <strong>{character.birth_year}</strong></p>
        <p>Gender: <strong>{capitalizeFirst(character.gender)}</strong></p>
      </div>
